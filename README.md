...
- Weekly review and reflection with saved end-of-week summaries
...
- `Weekly Review`: end-of-week completion snapshots, reflection prompts, and next-week recommendations
