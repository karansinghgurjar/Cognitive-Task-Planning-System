...
class CommandRegistryService {
  ...
  List<AppCommand> getCommands(CommandContext context) {
    return [
      ...
      const AppCommand(
        id: AppCommandId.openPlanningAssistant,
        title: 'Open Planning Assistant',
        subtitle: 'Turn natural-language intent into a structured draft plan',
        keywords: ['planning assistant', 'natural language plan', 'assistant'],
        category: CommandCategory.review,
        icon: Icons.psychology_alt_rounded,
        priority: 86,
      ),
      const AppCommand(
        id: AppCommandId.openKnowledge,
        title: 'Open Knowledge',
        subtitle: 'Open notes, resources, and revision workflows',
        keywords: ['knowledge', 'notes', 'resources', 'revision'],
        category: CommandCategory.review,
